...
public static partial class Defence
{
    ...
    /// <summary>
    /// <see cref="T:BaseValidation&lt;string&gt;"/> The object that can be used to validate
    /// </summary>
    /// <param name="fieldName">The field name that specifies the input validation result</param>
    /// <returns></returns>
    public static BaseValidation<string> Must(this string input, string fieldName)
    {
        return new BaseValidation<string>(new DefenceProperty<string>(fieldName, input), _defenceErrorHandler);
    }

    public static BaseValidation<IEnumerable<string>> Must(this IEnumerable<string> input, string fieldName)
    {
        return new BaseValidation<IEnumerable<string>>(new DefenceProperty<IEnumerable<string>>(fieldName, input), _defenceErrorHandler);
    }
